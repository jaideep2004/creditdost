            ...
            <div style={styles.contentCard}>
              ...
              <div style={styles.articleContent}>
                ...
                <div style={styles.blogMeta}>
                  By {blog?.author?.name || 'Admin'} | {blog?.createdAt ? formatDate(blog.createdAt) : 'October 19, 2024'} | 0 Comments
                </div>

                <div style={styles.blogText} dangerouslySetInnerHTML={{ __html: blog?.content || 'Aliquam eros justo, posuere loborti viverra laoreet matti ullamcorper posuere viverra .Aliquam eros justo, posuere lobortis non, viverra laoreet augue mattis fermentum ullamcorper viver laoreet Aliquam eros justo, posuere loborti viverra laoreet matti ullamcorper posuere viverra .Aliquam eros justo, posuere lobortis non' }} />
                ...
                <div style={styles.featureSection} className="feature-section">
                  <div style={styles.featureBox}>
                    ...
                    <p style={styles.featureText}>
                      Oshed fact that a reader will be dist acted bioiiy design ished fact that a reader will.
                    </p>
                  </div>
            ...
            <div style={styles.sidebarWidget}>
              ...
              {recentPosts.map((post, index) => (
                ...
                >
                  ...
                  <div>
                    <div style={styles.recentPostTitle} className="recent-post-title">
                      {post.title}
                    </div>
