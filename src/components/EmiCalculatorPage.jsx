...
const EmiCalculatorPage = () => {
  ...
  const calculateEMI = async () => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Error calculating EMI. Please try again.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <EmiBackground>
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center', mb: 6 }}>
            ...
            >
              Calculate your monthly loan payments and view the complete repayment schedule
            </Typography>
          </Box>
              ...
              <CardContent>
                ...
                <TableContainer component={Paper} sx={{ 
                  ...
                  <Table stickyHeader>
                    <TableHead>
                      <TableRow>
                        <TableCell sx={{ color: 'white', fontWeight: 600, backgroundColor: 'rgba(0, 0, 0, 0.3)' }}>Month</TableCell>
                        <TableCell sx={{ color: 'white', fontWeight: 600, backgroundColor: 'rgba(0, 0, 0, 0.3)' }}>EMI</TableCell>
                        <TableCell sx={{ color: 'white', fontWeight: 600, backgroundColor: 'rgba(0, 0, 0, 0.3)' }}>Interest</TableCell>
                        <TableCell sx={{ color: 'white', fontWeight: 600, backgroundColor: 'rgba(0, 0, 0, 0.3)' }}>Principal</TableCell>
                        <TableCell sx={{ color: 'white', fontWeight: 600, backgroundColor: 'rgba(0, 0, 0, 0.3)' }}>Balance</TableCell>
                      </TableRow>
                    </TableHead>
                    <TableBody>
                      {emiSchedule.map((row) => (
                        ...
                        >
                          ...
                          <TableCell sx={{ color: 'white' }}>₹{row.emi}</TableCell>
                          <TableCell sx={{ color: '#f59e0b' }}>₹{row.interest}</TableCell>
                          <TableCell sx={{ color: '#10b981' }}>₹{row.principal}</TableCell>
