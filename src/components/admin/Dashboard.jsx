...
const AdminDashboard = () => {
  ...
  const menuItems = [
    ...
    { text: 'Manage Franchises', icon: <PeopleIcon />, path: '/admin/franchises' },
    { text: 'Manage Packages', icon: <BusinessIcon />, path: '/admin/packages' },
    { text: 'Manage Leads', icon: <PeopleIcon />, path: '/admin/leads' },
    { text: 'Manage Payouts', icon: <AccountBalanceIcon />, path: '/admin/payouts' },
    { text: 'View Reports', icon: <AssessmentIcon />, path: '/admin/reports' },
    { text: 'Manage Referrals', icon: <GroupAddIcon />, path: '/admin/referrals' },
    { text: 'Surepass Settings', icon: <SettingsIcon />, path: '/admin/surepass-settings' },
    { text: 'Recharge Credits', icon: <CreditScoreIcon />, path: '/admin/recharge' },
  ];
